...
\input{the_big_picture}
\input{coupled_oscillator}
\input{basic_definitions_in_vector_spaces}
\input{linear_transformations_and_their_matrices}
\input{generalization_to_complex_vector_spaces}
